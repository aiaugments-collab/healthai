...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Health AI | Privacy Policy</title>
        <meta
          name="description"
          content="Read our Privacy Policy at Health AI. Learn how we collect, use, and protect your personal data."
        />
      </Head>
      <motion.div
        ...
        <div className="max-w-4xl mx-auto">
          <motion.header variants={slideInLeft} className="mb-12 text-center">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground">
              Your privacy is important to us at Health AI.
            </p>
          </motion.header>
          ...
          >
            <motion.article variants={fadeInUp}>
              ...
              <p>
                Welcome to Health AI. We are committed to protecting your
